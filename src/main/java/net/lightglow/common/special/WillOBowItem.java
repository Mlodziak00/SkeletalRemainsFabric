...
public class WillOBowItem extends BowItem {
            ...
            if (!itemStack.isEmpty() || bl) {
                ...
                if (!((double)f < 0.1)) {
                    ...
                    if (!world.isClient) {
                        ...
                        persistentProjectileEntity.setVelocity(playerEntity, playerEntity.getPitch(), playerEntity.getYaw(), 0.0F, f * 3.2F, 1.0F);
                        if (f == 1.0F) {
    ...
    public WillOBowItem(Settings settings) {
        super(settings);
    }
