...
public class CharredSkeletonModel<T extends CharredSkeleton> extends BipedEntityModel<T> {
    public CharredSkeletonModel(ModelPart modelPart) {
        super(modelPart);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("head_armor", ModelPartBuilder.create().uv(0,32).cuboid(-4.0F, -32.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.15F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
        modelPartData.addChild("body_armor", ModelPartBuilder.create().uv(16, 48).cuboid(-4.0F, -24.0F, -2.0F, 8.0F, 12.0F, 4.0F, new Dilation(0.1F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
        modelPartData.addChild("left_leg_armor", ModelPartBuilder.create().uv(0, 48).mirrored().cuboid(0.5F, -12.5F, -1.5F, 3.0F, 13.0F, 3.0F, new Dilation(-0.4F)).mirrored(false), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
        modelPartData.addChild("right_leg_armor", ModelPartBuilder.create().uv(0, 48).cuboid(0.5F, -12.5F, -1.5F, 3.0F, 13.0F, 3.0F, new Dilation(-0.4F)), ModelTransform.pivot(-4.0F, 24.0F, 0.0F));
        modelPartData.addChild("left_arm_armor", ModelPartBuilder.create().uv(40, 48).mirrored().cuboid(3.5F, -24.5F, -1.5F, 3.0F, 13.0F, 3.0F, new Dilation(-0.4F)).mirrored(false), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
        modelPartData.addChild("right_arm_armor", ModelPartBuilder.create().uv(40, 48).cuboid(-6.5F, -24.5F, -1.5F, 3.0F, 13.0F, 3.0F, new Dilation(-0.4F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
