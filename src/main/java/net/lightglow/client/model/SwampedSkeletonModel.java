...
public class SwampedSkeletonModel<T extends SwampedSkeleton> extends BipedEntityModel<T> {

	public SwampedSkeletonModel(ModelPart modelPart) {
		super(modelPart);
	}
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(0, 48).mirrored().cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)).mirrored(false)
		...
		modelPartData.addChild("right_leg", ModelPartBuilder.create().uv(0, 16).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F, new Dilation(0.0F))
		.uv(0, 48).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(-2.0F, 12.0F, 0.0F));
